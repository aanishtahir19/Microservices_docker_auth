    ...
    <div className='h-full bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4 min-h-screen'>
      <div className='flex flex-col items-center justify-center'>
        <div className='bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16'>
          <p className='focus:outline-none text-2xl font-extrabold leading-6 text-gray-800 mb-6'>
            Signup
          </p>
          ...
          <div className='relative pb-6'>
            ...
            />
            <div className='text-sm text-red-600 absolute bottom-0'>
              <ErrorMessage name='email' />
            </div>
          </div>
          <div className='mt-1  w-full relative pb-6'>
            <label
              htmlFor='pass'
              className='text-sm font-medium leading-none text-gray-800'
            >
